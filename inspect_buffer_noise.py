...
def inspect_dimension_noise(source_dir):
    ...
    all_log_stds = []
    LOG_STD_IDX = 7  # Make sure this is the correct Log Std Index you confirmed earlier
    ...
    # === Core change: per-dimension statistics ===
    # mean(axis=0) averages across time, preserving per-dimension differences
    ...
    # === Visualize per-dimension differences ===
