...
path = 'Transformer_RNN/embedding_log_task_dyn_true_seed_4/emb.pth'
    ...
    for ti, t in enumerate(task_ids):
        ...
        for ai, a in enumerate(arm_ids):
            ...
            plt.scatter(
                ...
                color=[color], marker=m, alpha=0.6, s=18, linewidths=0, rasterized=True
            )
        # 这里放大了图例里的圆点标识 (markersize=15)
