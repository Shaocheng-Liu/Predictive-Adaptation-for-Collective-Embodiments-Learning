...
path_own_loss = 'Transformer_RNN/embedding_log_task_dyn_true_seed_3/emb.pth'
...
def transformer_eval(path):
    ...
    sil_task = silhouette_score(data, y_pred_task, metric='euclidean', sample_size=10000)
    ...
    if 'task_arm' in datafile:
        ...
        sil_robot = silhouette_score(data, y_pred_robot, metric='euclidean', sample_size=10000) # 这里的 Silhouette 可能不如 Task 高，因为 Robot 只是 Embedding 的一个子特征
...
transformer_eval(path_own_loss)
