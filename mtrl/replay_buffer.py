...
class ReplayBuffer(object):
    ...
    def add_array(self, env_obs, action, reward, next_env_obs, done, task_obs, size):
        ...
        self.idx = (self.idx + size) % self.capacity #TODO: need to add saftey bounds if too many element are added after buffer reached capacity
        self.full = self.full or self.idx == 0
